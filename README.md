...
```bash
kbb -M:dev:run     # walk two clean lend+preserve lifecycles (no conservator required, conservator required-and-obtained), plus four HARD-hold cases, through the actor
