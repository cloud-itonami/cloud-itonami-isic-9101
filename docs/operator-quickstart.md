# Operator Quickstart — Community Library and Archive

Shortest path from clone to a verified local dry-run for **ISIC 9101** (`cloud-itonami-isic-9101`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9101.git
cd cloud-itonami-isic-9101
```
...
- Blueprint governor key: `library-governor`
- Likely source path: `libraryops.governor.cljc`
